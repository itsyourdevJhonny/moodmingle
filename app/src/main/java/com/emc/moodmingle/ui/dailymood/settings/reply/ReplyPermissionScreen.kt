package com.emc.moodmingle.ui.dailymood.settings.reply
...
import com.emc.moodmingle.data.firebase.model.post.dailymood.settings.ReplyPermissionType
    ...
    Column(
        ...
        ReplyPermissionType.entries.forEach { permission ->
            ReplyPermissionItem(
                ...
                onClick = { onSettingsEdited(settings.copy(replyPermissionType = permission)) }
            )
