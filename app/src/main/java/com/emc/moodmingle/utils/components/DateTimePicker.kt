...
fun DateTimePicker(
    ...
    Scaffold(
        ...
        ScheduleDialogContent(paddingValues, dateTimeState) { dateTimeState = it }
    }
}
...
private fun ScheduleDialogContent(
    ...
    dateTimeState: DateTimePickerState,
    onDateTimeStateChanged: (DateTimePickerState) -> Unit,
) {
    ...
    Column(
        ...
        Box {
            Column(
                ...
                when (currentSection) {
                    1 -> DatePickerSection(datePickerState)
                    2 -> TimePickerSection(timePickerState)
                }
            }
        }
...
private fun IndicatorText(currentSection: Int) {
    Text(
        text = "Select ${if (currentSection == 1) "Date" else "Time"}",
...
@Composable
@OptIn(ExperimentalMaterial3Api::class)
private fun DatePickerSection(datePickerState: DatePickerState) {
    DatePicker(
        title = null,
...
@Composable
@OptIn(ExperimentalMaterial3Api::class)
private fun TimePickerSection(timePickerState: TimePickerState) {
    TimePicker(
