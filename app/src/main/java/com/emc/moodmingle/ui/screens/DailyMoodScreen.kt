...
fun TextSection(
    ...
    BasicTextField(
        ...
        onValueChange = {
            text = it
            onTextCreated(dailyMoodText.copy(text = it))
        },
        cursorBrush = SolidColor(Color.White),
        textStyle = LocalTextStyle.current.copy(
            color = dailyMoodText.color.toColor(),
            fontSize = 20.sp,
            textAlign = if (dailyMoodText.align.toTextAlign() == TextAlign.Unspecified && text.isEmpty()) TextAlign.Center else dailyMoodText.align.toTextAlign(),
...
fun TextDialogContent(
    ...
    Box(
        ...
        Column(
            ...
            TextSection(dailyMoodText, isFocused, focusRequester, onFocused, onTextCreated)
