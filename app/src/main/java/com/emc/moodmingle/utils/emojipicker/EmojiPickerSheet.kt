...
import com.emc.moodmingle.utils.emojipicker.utils.StatusBarPadding
...
fun EmojiPickerSheet(
    ...
    Column(
        modifier = modifier
            ...
            .defaultMinSize(minHeight = ComposeEmojiPickerBottomSheetConstants.defaultMinHeight)
    ) {
        StatusBarPadding()
