package com.emc.moodmingle.ui.dailymood.settings.archive
...
fun AutoArchiveScreen(
    ...
    Scaffold(
        ...
        topBar = { ScaffoldHeader(title = "Auto Archive") { onDismiss() } }
    ) { paddingValues ->
...
private fun ToggleButton(
    ...
    Switch(
        ...
        onCheckedChange = { onSettingsEdited(settings.copy(autoArchive = it)) },
