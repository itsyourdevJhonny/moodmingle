    ...
    Column(
        ...
        AnimatedVisibility(visible = state.speed != 1f) {
            TextButton(
                ...
                Icon(
                    painter = painterResource(androidx.media3.session.R.drawable.media3_icon_rewind),
        ...
        Slider(
            ...
            onValueChange = { onStateChanged(state.copy(speed = it)) },
            ...
            thumb = { state ->
                Icon(
                    painter = painterResource(androidx.media3.session.R.drawable.media3_icon_playback_speed),
                    contentDescription = null,
                    tint = Color.White,
