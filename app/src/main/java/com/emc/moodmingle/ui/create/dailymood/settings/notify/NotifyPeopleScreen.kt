package com.emc.moodmingle.ui.create.dailymood.settings.notify
...
import com.emc.moodmingle.domain.remote.model.post.dailymood.settings.NotifyType
import com.emc.moodmingle.ui.theme.GrayTextColor
import com.emc.moodmingle.ui.theme.Typography

@Composable
fun NotifyPeopleScreen(settings: DailyMoodSettings, onEdit: (DailyMoodSettings) -> Unit) {
    Text(
    ...
    NotifyOption(
        ...
        onClick = { onEdit(settings.copy(notifyType = NotifyType.NONE)) }
    )
    ...
    NotifyOption(
        ...
        onClick = { onEdit(settings.copy(notifyType = NotifyType.FOLLOWERS)) }
    )
    ...
    NotifyOption(
        ...
        onClick = { onEdit(settings.copy(notifyType = NotifyType.SUPPORTERS)) }
    )
