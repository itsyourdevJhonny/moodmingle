package com.emc.moodmingle.ui.create.dailymood.settings.shareplatform
...
import com.emc.moodmingle.domain.remote.model.post.dailymood.settings.SharePlatformType
...
@Composable
fun SharePlatformScreen(settings: DailyMoodSettings, onEdit: (DailyMoodSettings) -> Unit) {
    Text(
