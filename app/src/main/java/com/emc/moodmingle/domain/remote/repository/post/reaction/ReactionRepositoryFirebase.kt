package com.emc.moodmingle.domain.remote.repository.post.reaction

import com.emc.moodmingle.domain.remote.model.post.reaction.ReactionEntityFirebase
 ...
 */
class ReactionRepositoryFirebase(
    ...
    suspend fun getReactionByUserAndPost(reactorId: String, postId: String): ReactionEntityFirebase? {
