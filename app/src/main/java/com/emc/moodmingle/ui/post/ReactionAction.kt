...
fun ReactionAction(globalLikesState: MutableState<Int>) {
    ...
    val displayColor = mapOf(
        R.drawable.scary to Color(0xFFCF8CF6),
        R.drawable.happy to Color(0xFFFFD600),
        R.drawable.wow to Color(0xFFFFAB00),
        R.drawable.sad to Color(0xFF00B8D4),
        R.drawable.angry to Color(0xFFD50000)
    )
    ...
    Box(
        ...
        if (displayIcon != null) {
            ...
            Icon(
                ...
                tint = if (isReacted) Color(0xFFD50000) else Color.White
            )
        }
    }
            ...
            Column(
                ...
                Row(
                    ...
                    reactions.forEach { (emoji, label) ->
                        ...
                        val reactedSize = if (isReacted && emoji == selectedReaction) {
                            62.dp
                        } else {
                            45.dp
                        }
                        ...
                        Column(
                            ...
                            Text(
                                ...
                                style = MaterialTheme.typography.labelSmall.copy(
                                    ...
                                    fontSize = if (isReactedAndSelected) {
