package com.emc.moodmingle.ui.create.dailymood.settings.autosave
...
@Composable
fun AutoSaveToDeviceScreen(settings: DailyMoodSettings, onEdit: (DailyMoodSettings) -> Unit) {
...
private fun ToggleButton(settings: DailyMoodSettings, onEdit: (DailyMoodSettings) -> Unit) {
    Switch(
        ...
        onCheckedChange = { onEdit(settings.copy(autoSaveToDevice = it)) },
