...
@Composable
fun MoodNoteVisibility(userEntityFirebase: UserEntityFirebase) {
    val scope = rememberCoroutineScope()
    val userViewModelFirebase = hiltViewModel<FirebaseUserViewModel>()
    var isDisabled by remember(userEntityFirebase) { mutableStateOf(userEntityFirebase.moodNoteDisabled) }
    ...
    Box(
        modifier = Modifier
            ...
            .clickable {
                scope.launch {
                    userViewModelFirebase.updateUser(userEntityFirebase.copy(moodNoteDisabled = !isDisabled))
                }
            },
    ) {
        Row(
            ...
            Icon(
                painter = painterResource(R.drawable.mood_note),
                contentDescription = "Mood Note",
                modifier = Modifier
                    .size(20.dp)
            ...
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(text = "Mood Note ", style = Typography.bodyMedium)
