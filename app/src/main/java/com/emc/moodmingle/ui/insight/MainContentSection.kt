...
fun MainContent(
    ...
    // trigger data load when userId changes
    ...
    // placeholder for previous data comparison (you can compute real one later)
//    val previousData = remember { InsightData(0, 0, 0, 0.0) }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Row(
                ...
                StatCard("Avg Score", insightData.avgScore.toString(), Color(0xFF66BB6A))
            }
