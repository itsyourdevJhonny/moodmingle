package com.emc.moodmingle.ui.create.dailymood.settings.screenprotection
...
@Composable
fun ScreenProtectionScreen(settings: DailyMoodSettings, onEdit: (DailyMoodSettings) -> Unit) {
...
private fun ToggleButton(settings: DailyMoodSettings, onEdit: (DailyMoodSettings) -> Unit) {
    Switch(
        ...
        onCheckedChange = { onEdit(DailyMoodSettings(screenProtectionEnabled = it)) },
