...
private fun Content(
    ...
    Column(
        ...
        SelectionItem(
            ...
            onSettingsEdited(settings.copy(replay = settings.replay.copy(type = ReplayLimitType.UNLIMITED)))
        }
        ...
        SelectionItem(
            ...
            onSettingsEdited(settings.copy(replay = settings.replay.copy(type = ReplayLimitType.ONCE)))
        }
        ...
        SelectionItem(
            ...
            if (!isCustom) {
                onSettingsEdited(settings.copy(replay = settings.replay.copy(type = ReplayLimitType.CUSTOM)))
            }
        }
        ...
        if (isCustom) {
            ...
            Slider(
                ...
                onValueChange = {
                    onSettingsEdited(settings.copy(replay = settings.replay.copy(customLimit = it.toInt())))
                },
                valueRange = 1f..20f,
                steps = 18,
